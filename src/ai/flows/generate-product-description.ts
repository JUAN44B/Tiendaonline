 ...
 *
 * - generateProductDescription - A function that generates a product description based on the product name.
...
const prompt = ai.definePrompt({
  ...
  Generate a product description for the following product name:
